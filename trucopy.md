...
**Website:** trucopy.org (SCAM - DO NOT USE)

---

## ⚠️ WARNING: SCAM WALLET ADDRESSES - DO NOT SEND FUNDS ⚠️

### Bitcoin (BTC) - $25,031.80 STOLEN
```
bc1qkh2g6dz0s5am5tjwc9wjylyj9qdalgq3vwmgtf
```

### Ethereum (ETH) - $5.01 STOLEN
```
0x3fb847c3fb6e8bc02b18e7af663a1eaa06e42529
```

### Solana (SOL) - $5,833.09 STOLEN
```
Cgrr9RgazhDtigGSu3GAYDbCUV3b1KqPPmuhuUqaoxWJ
```

### Bitcoin Cash (BCH) - No transactions yet
```
qpacqjaveqpe04rjeqwvhrvqv3hlf6zx7gecghke0s
```

### Tron TRC20 (USDT) - No transactions yet
```
THGF14Xbju5nj2PZBW4yzCyLZCSj7ftZhw
```

### Litecoin (LTC) - No transactions yet
```
Lhice6C2VmNo9FwgGfjPo7spr9T7Yo9NwC
```

### Dogecoin (DOGE) - No transactions yet
```
DE3BCqMmFNMs1VqGTcLCJVFPe2qCoPewij
```

---

## Cash-Out Destination Wallets (Scammer's Personal Wallets)

### SOL Cash-Out Wallet - received $5,832 total
```
7Ab4npbSR7cTi1gKBW6EiUHco5L5HrsCVDRns8j2DiFQ
```

### BTC Cash-Out Wallet #1 - received $20,656
```
bc1qdqqsq6y7csd0cr3ye45h9lv8ydh777j2wehgl6
```

### BTC Cash-Out Wallet #2 - received $4,382
```
bc1q3lum3k6q738f3ct76zg47gshz8rn8ggph6smk3
```

### ETH Swap Destination - received $2.51
```
...
## Exchange Hot Wallets (KYC Source Evidence)

### Kraken SOL Hot Wallet - sent $3,908.10 to scam
```
FWznbcNXWQuHTawe9RxvQ2LdCENssh12dsznf4RiouN5
```

### Coinbase SOL Hot Wallet - sent $1,924.99 to scam
```
...
## Victim Source Wallets (For Identification/Testimony)

### BTC Victim Wallet - sent $25,028 total (2 deposits)
```
bc1qsatlphjcgvzlt9xhsgn0dnjus5jgwg83dr05c6
```

### ETH Victim Wallet - sent $5.01
```
0x3b821941578c09f39c1dadb174f64a575307610b
```
...
ETH moved via **"On Chain Swap"** to the ETH Swap Destination wallet listed above.
